...
<body>
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="contato.php">Como chegar</a></li>
  ...
  <section class="contato">
    <div class="container-fluid text-center" style="margin-top:50px; background-color:#bdc43b; height:80px;">
  ...
  <section class="orcamento">
    ...
    <div class="container">
        ...
        <div class="col-sm-8 col-xs-12">
          <h2 align="left" style="padding-bottom:10px;">Nosso conceito</h2>
